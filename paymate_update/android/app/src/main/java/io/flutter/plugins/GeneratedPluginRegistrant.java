...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.dynamsoft.dcv.flutter.DynamsoftCaptureVisionFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin dynamsoft_capture_vision_flutter, com.dynamsoft.dcv.flutter.DynamsoftCaptureVisionFlutterPlugin", e);
    }
    try {
